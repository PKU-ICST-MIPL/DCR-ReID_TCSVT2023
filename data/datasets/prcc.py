    ...
    def _process_dir_train(self, dir_path):
        ...
        for pdir in pdirs:
            ...
            for img_dir in img_dirs:
                ...
                cloth_path = img_dir.replace('/rgb/', '/cloth/')
                _cloth_path = img_dir.replace('/rgb/', '/cloth_/')
                contour_path = img_dir.replace('/rgb/', '/contour/')
                dataset.append((img_dir, label, camid, clothes_id, cloth_path, _cloth_path, contour_path))
