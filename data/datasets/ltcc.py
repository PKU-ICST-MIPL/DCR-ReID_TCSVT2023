...
class LTCC(object):
    ...
    def _process_dir_train(self, dir_path):
        ...
        for img_path in img_paths:
            ...
            cloth_path = img_path.replace('/train/', '/train_cloth/')
            _cloth_path = img_path.replace('/train/', '/train_cloth_/')
            contour_path = img_path.replace('/train/', '/train_contour/')
            dataset.append((img_path, pid, camid, clothes_id, cloth_path, _cloth_path, contour_path))
