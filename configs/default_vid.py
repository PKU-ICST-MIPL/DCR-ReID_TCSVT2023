...
_C.DATA.TRAIN_BATCH = 8 # 16
# Batch size for testing
_C.DATA.TEST_BATCH = 64 # 128
...
# Random erase prob
_C.PARA.SHUF_ADV_CLO_RATIO = 0.05
# Random flip prob
...
_C.MODEL.HID_REC_DIM = 2048
# No cLoth dim for model
_C.MODEL.NO_CLOTHES_DIM = 1024
# Contour dim for model
_C.MODEL.CONTOUR_DIM = 512
# CLoth dim for model
_C.MODEL.CLOTHES_DIM = 512
# -----------------------------------------------------------------------------
# Losses for training 
# -----------------------------------------------------------------------------
_C.LOSS = CN()
